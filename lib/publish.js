...
module.exports = async (pluginConfig, context) => {
  ...
  debug(`Notes: ${notes}`)
  logger.log(`Release Version: ${notes}`)
  ...
  if (success) {
    try {
      ...
      await page.click(selector)
      await nav
      // TODO based on env var we could auto-delete the added version
      // find out the created version id for the version number
      // https://marketplace.whmcs.com/product/1650/versions/2782/delete
